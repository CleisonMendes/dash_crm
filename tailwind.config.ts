    ...
    extend: {
      colors: {
        ...
        burgundy: {
          ...
          secondary: "hsl(var(--burgundy-secondary))",
        ...
        wine: {
          ...
          sidebar: "hsl(var(--wine-sidebar))",
          beige: "hsl(var(--wine-beige))",
          gold: "hsl(var(--wine-gold))",
          brown: "hsl(var(--wine-brown))",
          "gold-light": "hsl(var(--wine-gold-light))",
          "blue-light": "hsl(var(--wine-blue-light))",
          "orange-light": "hsl(var(--wine-orange-light))",
          yellow: "hsl(var(--wine-yellow))",
        },
        chart: {
          "1": "hsl(var(--chart-1))",
          "2": "hsl(var(--chart-2))",
