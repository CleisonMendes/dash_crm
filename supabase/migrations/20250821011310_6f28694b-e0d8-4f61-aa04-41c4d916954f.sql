...
-- Create a function to clear all fictitious data from the system
...
-- Grant execute permission to authenticated users (will be restricted by RLS in the application)
